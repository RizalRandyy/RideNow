                ...
                <div class="list-1">
                    <div class="harga">
                        <div class="harga-list">
                            <p><?php echo "Rp. " . number_format($row['price_per_day'], 2, ",", "."); ?></p>
                        </div>
                    </div>
                    ...
                    <div class="order-btn"><a href="booking/add_booking.php?id=<?php echo $row['motorcycle_id']; ?>" class="button">Pesan</a></div>
                </div>
            <?php } ?>
        </div>
